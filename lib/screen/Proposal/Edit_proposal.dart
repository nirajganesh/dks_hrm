...
class Edit_proposal extends StatefulWidget {

  String id,name,short_descr,long_descr,follow_up_date,token,status;
  List<String> client_drop_list=[];
  bool theme;

  Edit_proposal({required this.client_drop_list,
    required this.id,required this.name,required this.short_descr,
    required this.long_descr,required this.follow_up_date,
    required this.status,required this.token,
    required this.theme,Key? key}) : super(key: key);

  @override
  _Edit_proposalState createState() => _Edit_proposalState();
}

class _Edit_proposalState extends State<Edit_proposal> {
  ...
  void initState() {
    ...
    choose_client=widget.name;
    Clientnamecontroller.text=widget.name;
    Followupcontroller.text=widget.follow_up_date;
  ...
  Widget build(BuildContext context) {
    return
      ...
      Scaffold(
      appBar: AppBar(
        title: Text("Edit Proposal",style: TextStyle(color: Colors.white),),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                //     updateProposal();
                //   },
                //   child: Text("Save Proposal",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                // ),
              ],
            ),
          ),
  ...
  Future updateProposal() async
  {
    ...
    var response=await Proposal_service.updateProposal_Multipart(widget.id,client_id,file?.path??"",ShortDescriptioncontroller.text,
