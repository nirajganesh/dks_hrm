...
class Add_service extends StatefulWidget {
  ...
  bool theme;
  Add_service({required this.cat_drop_list,required this.token,required this.theme,Key? key}) : super(key: key);
...
class _Add_serviceState extends State<Add_service> {
  ...
  void initState() {
    ...
    choose_category=widget.cat_drop_list.first;
  }
  ...
  Future addService() async
  {
    ...
    var response=await service.addService(category_id,Servicenamecontroller.text,ShortDescriptioncontroller.text,
        LongDescriptioncontroller.text,Pricecontroller.text,Statuscontroller.text,widget.token);
