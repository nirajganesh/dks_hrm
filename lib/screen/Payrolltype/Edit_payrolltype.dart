...
class Edit_payrolltype extends StatefulWidget {
  String token;
  String salary_type;
  String create_date;
  String id;
  bool theme;
  Edit_payrolltype({required this.id,required this.salary_type,required this.create_date,
    required this.token,required this.theme,Key? key}) : super(key: key);

  @override
  _Edit_payrolltypeState createState() => _Edit_payrolltypeState();
}

class _Edit_payrolltypeState extends State<Edit_payrolltype> {
  ...
  void initState() {
    ...
    super.initState();
    Salarytypecontroller.text=widget.salary_type;
    Createdatecontroller.text=widget.create_date;
  }
  @override
  Widget build(BuildContext context) {
    return
      ...
      Scaffold(
      appBar: AppBar(
        title: Text("Edit PayslipsType",style: TextStyle(color: Colors.white),),
  ...
  Future updatePayrolltype() async
  {
    var response=await Payroll_type_service.updatePayroll_type(widget.id,Salarytypecontroller.text,Createdatecontroller.text,widget.token);
