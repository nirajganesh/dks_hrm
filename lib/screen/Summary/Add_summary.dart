...
class Add_summary extends StatefulWidget {
  ...
  @override
  _Add_summaryState createState() => _Add_summaryState();
  
}

class _Add_summaryState extends State<Add_summary> {
  ...
  Future addService_summary() async
  {
    ...
    if(choose_bill=="BILL")
      {
        Billedcontroller.text="1";
      }
    else
      {
        Billedcontroller.text="0";
      }

    var response=await Summary_service.addService_summary(widget.client_id,service_id,Descriptioncontroller.text,
