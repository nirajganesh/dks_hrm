...
import 'package:dks_hrm/screen/Summary/Checker/Service_Invoice_edit.dart';
...
class Service_add_invoice extends StatefulWidget {
  ...
  @override
  _Service_add_invoiceState createState() => _Service_add_invoiceState();
}

class _Service_add_invoiceState extends State<Service_add_invoice> {
              ...
              children: [
                ...
                TouchRippleEffect(
                  ...
                  onTap: (){
                    ...
                    {
                      Navigator.push(context, MaterialPageRoute(builder: (context) =>Service_Invoice_edit(
