...
class Invoice_edit_item_modal extends StatefulWidget {
  ...
  @override
  _Invoice_edit_item_modalState createState() => _Invoice_edit_item_modalState();
}

class _Invoice_edit_item_modalState extends State<Invoice_edit_item_modal> {
          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: Text("Edit Invoice Items",style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold),),
              ),
              GestureDetector(
                  onTap: (){
            ...
            children: [
              Row(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(left:5.0),
                    child: Text("Edit Invoice Items",style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold),),
                  ),
                  GestureDetector(
                      onTap: (){
                        Navigator.of(context).pop();
