...
class Invoice_detail_edit_modal extends StatefulWidget {

  Invoice_detail_edit_modal({
  ...
  @override
  _Invoice_detail_edit_modalState createState() => _Invoice_detail_edit_modalState();
}

class _Invoice_detail_edit_modalState extends State<Invoice_detail_edit_modal> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left:5.0),
                      child: Text("Edit Invoice Details",style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold),),
                    ),
                    GestureDetector(
                        onTap: (){
                          Navigator.of(context).pop();
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width:8.0),
                        Container(
                          child:Text(widget.inv_id,style: (TextStyle(color: Colors.white,fontSize: 14)),),
                        ),
                      ],
                    ),
                  ),
                          ...
                          Flexible(
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width:8.0),
                                Text(
                                  widget.inv_date,style: (TextStyle(color: Colors.white,fontSize: 14)),
                                ),
                              ],
                            ),
                          ),
                          ...
                          Flexible(
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width:8.0),
                                Text(
                                  widget.due_date,style: (TextStyle(color: Colors.white,fontSize: 14)),
                                ),
                              ],
                            ),
                          ),
