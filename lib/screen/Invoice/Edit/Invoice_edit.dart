...
class Invoice_edit extends StatefulWidget {
  ...
  @override
  _Invoice_editState createState() => _Invoice_editState();
}

class _Invoice_editState extends State<Invoice_edit> {
