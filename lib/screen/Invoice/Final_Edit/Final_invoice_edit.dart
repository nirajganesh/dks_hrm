...
import 'package:dks_hrm/screen/Invoice/Final_Edit/Final_detail_edit_modal.dart';
...
class Final_invoice_edit extends StatefulWidget {
  ...
  @override
  _Final_invoice_editState createState() => _Final_invoice_editState();
}

class _Final_invoice_editState extends State<Final_invoice_edit> {
  ...
  Widget build(BuildContext context) {
    return
      widget.theme==true?
      Scaffold(
      appBar: App_bar_widget.App_bar(context,"Edit Final Invoice List",Colors_theme.light_app_color),
      body:
      Container(
      ...
      Scaffold(
        appBar: App_bar_widget.App_bar(context,"Edit Final Invoice List",Colors_theme.dark_app_color),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text("#"+widget.invoice_no,style: TextStyle(color:Colors.white24,fontSize: 16),),
                                          Text(widget.invoice_date,style: TextStyle(color:Colors.white24,fontSize: 16),),
                                        ],
                                      ),
                                      SizedBox(height: 5,),
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(widget.due_date,style: TextStyle(color:Colors.white24,fontSize: 14),),
                                        ],
                                      ),
  ...
  onSubtotal()
  {
    setState(() {
      ...
      PaidtotalController.text=GrandtotalController.text;
    }
    );
  }
  ...
  Future updateQuotation() async
  {
    ...
    var response=await Invoice_service.updateInvoice(
        ...
        PaidtotalController.text,"0",RemarkController.text,'1',
    ...
    if(response['status']==200)
    {
      ...
      Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (BuildContext context) =>
          Final_invoice()), (Route<dynamic> route) => false);
    }
    else
    {
      Navigator.pop(context);
