...
class Final_edit_item_modal extends StatefulWidget {
  ...
  @override
  _Final_edit_item_modalState createState() => _Final_edit_item_modalState();
}

class _Final_edit_item_modalState extends State<Final_edit_item_modal> {
