...
class Edit_final_invoice extends StatefulWidget {
  ...
  Edit_final_invoice({required this.id,required this.client_drop_list,required this.service_drop_list,
    required this.invoice_no,required this.invoice_date,required this.due_date,required this.remark,
    required this.token,required this.total,required this.total_paid,required this.total_due,Key? key}) : super(key: key);

  @override
  _Edit_final_invoiceState createState() => _Edit_final_invoiceState();
}

class _Edit_final_invoiceState extends State<Edit_final_invoice> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Edit Final Invoice",style: TextStyle(color: Colors.white),),
                          ...
                          if(choose_client==null)
                           {
                            ...
                            Navigator.push(context, MaterialPageRoute(
                                builder: (context) =>
                                    Edit_item_final_invoice(
                                      inv_id: widget.id,
                                      service_drop_list: widget
                                          .service_drop_list,
