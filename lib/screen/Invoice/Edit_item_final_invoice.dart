...
class Edit_item_final_invoice extends StatefulWidget {
  ...
  @override
  _Edit_item_final_invoiceState createState() => _Edit_item_final_invoiceState();
}

class _Edit_item_final_invoiceState extends State<Edit_item_final_invoice> {
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 10,),
                                  Text("PAID",style:TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold),),
                                ],
                              ),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
  ...
  Future editInvoice() async
  {
    ...
    else
    {
      ...
      print(array_list);
      var response=await Invoice_service.updateInvoice(widget.inv_id,widget.inv_no,client_id,widget.inv_date,widget.due_date,Grandtotalcontroller.text,
          '',Grandtotalcontroller.text,Grandtotalcontroller.text,widget.total_due,widget.remarks,'1','',array_list,token);
      if(response['status']==200)
      {
        Navigator.pop(context);
        Notify_widget.notify(response['message']);
