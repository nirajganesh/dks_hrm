...
class Add_category extends StatefulWidget {
  String token;
  bool theme;
  Add_category({required this.token,required this.theme,Key? key}) : super(key: key);
...
class _Add_categoryState extends State<Add_category> {
  ...
  Widget build(BuildContext context) {
    return
      widget.theme==true?
      Scaffold(
      appBar: App_bar_widget.App_bar(context,"Add Category",Colors_theme.light_app_color),
      body: Container(
      ...
      Scaffold(
        appBar: App_bar_widget.App_bar(context,"Add Category",Colors_theme.dark_app_color),
        body: Container(
          decoration: BoxDecoration(
  ...
  {
    var response=await Service_category_service.addCategory(Categorynamecontroller.text,widget.token);
