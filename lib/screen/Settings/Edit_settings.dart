...
class Edit_settings extends StatefulWidget {
  ...
  String id,compony_name,site_logo,sitetitle,copyright,contact,system_email,currency,symbol,address,bank_name,
      account_no,account_name,ifsc,upi_id,token,image;

  bool theme;
  Edit_settings({required this.id,required this.compony_name,required this.site_logo,required this.sitetitle,required this.copyright,
     required this.contact,required this.system_email,required this.currency,
     required this.symbol,required this.address,required this.bank_name,
     required this.account_no,required this.account_name,required this.ifsc,
     required this.upi_id,required this.token,required this.image,
     required this.theme,Key? key}) : super(key: key);

  @override
  _Edit_settingsState createState() => _Edit_settingsState();
}

class _Edit_settingsState extends State<Edit_settings> {
  ...
  final TextEditingController Systememailcontroller= TextEditingController();
  ...
  void initState() {
    ...
    super.initState();
    Companynamecontroller.text=widget.compony_name;
    Sitetitlecontroller.text=widget.sitetitle;
    Copyrightcontroller.text=widget.copyright;
    Contactcontroller.text=widget.contact;
    Currencycontroller.text=widget.currency;
    Systememailcontroller.text=widget.system_email;
    Symbolcontroller.text=widget.symbol;
    Addresscontroller.text=widget.address;
    Banknamecontroller.text=widget.bank_name;
    Accountnocontroller.text=widget.account_no;
    Accountnamecontroller.text=widget.account_name;
    IFSCcontroller.text=widget.ifsc;
    Upiidcontroller.text=widget.upi_id;
  }
  @override
  Widget build(BuildContext context) {
    return widget.theme==true?
      Scaffold(
      appBar: AppBar(
        title: Text("Edit Settings",style: TextStyle(color: Colors.white),),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left:8.0,right:8.0),
                        child: Icon(Icons.account_balance_wallet,color: Colors.black38),
                      ),
                      Container(
                        width: 1.0,
                        height: 25.0,
      ...
      TouchRippleEffect(
        ...
        onTap: (){
          ...
          {
            if(Sitetitlecontroller.text.isNotEmpty)
            {
              if(Copyrightcontroller.text.isNotEmpty)
              {
                if(Contactcontroller.text.isNotEmpty)
                {
                  if(Systememailcontroller.text.isNotEmpty)
                  {
                    if(Currencycontroller.text.isNotEmpty)
                    {
                          ...
                          if(Banknamecontroller.text.isNotEmpty)
                          {
                            if(Accountnamecontroller.text.isNotEmpty)
                            {
                              if(IFSCcontroller.text.isNotEmpty)
                              {
                                ...
                                {
                                  Notify_widget.notify("Please add the upi id");
                                }
                              }
                              else
                              {
                            ...
                            {
                              Notify_widget.notify("Please add the account name");
                            }
                          }
                          else
                          {
                      ...
                      {
                        Notify_widget.notify("Please add the symbol");
                      }
                    }
                    else
                    {
                      Notify_widget.notify("Please add the currency");
                    }
                  }
                  else
                  {
                    Notify_widget.notify("Please add the email");
                  }
                }
                else
                {
                  Notify_widget.notify("Please add the contact");
                }
              }
              else
              {
                Notify_widget.notify("Please add the copyright");
              }
            }
            else
            {
              Notify_widget.notify("Please add the name of");
            }
          }
          else
          {
            Notify_widget.notify("Please add the compony name");
          }
        },
        child: Container(
          height: 50,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left:8.0,right:8.0),
                        child: Icon(Icons.account_balance,color: Colors.white24),
                      ),
                      Container(
                        width: 1.0,
                        height: 25.0,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left:8.0,right:8.0),
                        child: Icon(Icons.account_balance_wallet,color: Colors.white24),
                      ),
                      Container(
                        width: 1.0,
                        height: 25.0,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left:8.0,right:8.0),
                        child: Icon(Icons.description,color: Colors.white24),
                      ),
                      Container(
                        width: 1.0,
                        height: 25.0,
  ...
  {
    var response=await Settings_service.updateSettings(widget.id,file?.path??"",Sitetitlecontroller.text,
        Copyrightcontroller.text,Contactcontroller.text,Currencycontroller.text,
        Symbolcontroller.text,Systememailcontroller.text,Addresscontroller.text,Banknamecontroller.text,
        Accountnamecontroller.text,Accountnocontroller.text,IFSCcontroller.text,Upiidcontroller.text,
        widget.token);
