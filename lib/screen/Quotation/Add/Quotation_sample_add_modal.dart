...
class Quotation_sample_add_modal extends StatefulWidget {
  ...
  @override
  _Quotation_sample_add_modalState createState() => _Quotation_sample_add_modalState();
}

class _Quotation_sample_add_modalState extends State<Quotation_sample_add_modal> {
          ...
          Row(
            ...
            children: [
             Padding(
               ...
               child: Text("Add Quotation Items",style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold),),
             ),
             GestureDetector(
                 onTap: (){
                      ...
                      child: TextField(
                        ...
                        onChanged: (value){
                          setState(() {
                            if(value=='')
                              value!=0;
                            total=(int.parse(value)*int.parse(Pricecontroller.text)).toString();
                          });
                        },
                        decoration: InputDecoration(
                            border: InputBorder.none,
            ...
            children: [
              Row(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(left:6.0),
                    child: Text("Add Quotation Items",style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold),),
                  ),
                  GestureDetector(
                      onTap: (){
                        Navigator.of(context).pop();
  ...
  onAdd()  async {
    ...
    setState(() {
      ContactModel contactModel = ContactModel(id: widget.contactForms.length,item_name: Servicecontroller.text,description:Descriptioncontroller.text,
        ...
        widget.contactForms.add(Quotation_sample_list_add(
